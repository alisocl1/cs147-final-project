...
#define SAS_TOKEN "SharedAccessSignature sr=iot147bruh.azure-devices.net%2Fdevices%2F147esp32&sig=5driCz7QlX0feHmzwBhPvHbQS38xGF9sQnxTxU9pUcE%3D&se=1732012643"
...
void loop() {
    ...
    String humidity = String(h, 2); // Keep 2 decimal points
